    ...
    <div class="row justify-content-center" style="min-height: 670px;">
        <div class="col-xl-12 col-md-12 col-sm-12 pt-5" style="padding-bottom: 120px">
            <ul class="nav nav-pills" id="pills-tab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">Lapor</a>
                </li>
            </ul>
                                ...
                                <div class="card-body pr-0">
                                    <div class="card">
                                        ...
                                        <div class="card-body p-2">
                                            <button type="button" class="btn btn-outline-default waves-effect w-100 text-left"><i class="fas fa-user pr-1 text-primary" aria-hidden="true"></i> Data Profil <i class="if-md fa-solid fa-chevron-right float-right mt-1"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <form class=" text-secondary">
                                                <div class="form-row pt-3 text-secondary">
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="validationDefault01" placeholder="Nama" value="<?= $user_data[0]['nama'] ?>" required>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col-md-12 mb-3">
                                                        <label for="validationDefault02">NPWP</label>
                                                        <input type="text" class="form-control" id="validationDefault02" placeholder="NPWP" value="<?= $user_data[0]['npwp'] ?>" required readonly>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col-md-12 mb-3">
                                                        <label for="validationDefault03">Email</label>
                                                        <input type="email" class="form-control" id="validationDefault03" placeholder="Email" value="<?= $user_data[0]['email'] ?>" required readonly>
                                                    </div>
                                                </div>
...
<script>
    $(document).ready(function() {
        $('a[data-toggle="pill"]').on('shown.bs.tab', function(e) {
            ...
            sessionStorage.setItem('activeTab-member', activeTab);
        });
        // kembalikan tab yang aktif dari session storage
        var activeTab = sessionStorage.getItem('activeTab-member');
        if (activeTab) {
